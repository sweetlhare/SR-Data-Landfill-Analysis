...
CREATE TABLE "landfills" (
  ...
  "manager" json,
  "type" text,
  CONSTRAINT "FK_landfills.region_id"
...
CREATE TABLE "surveys" (
  ...
  CONSTRAINT "FK_surveys.landfill_id"
    FOREIGN KEY ("landfill_id")
      REFERENCES "landfills"("id")
);
...
CREATE TABLE "images" (
  ...
  CONSTRAINT "FK_images.survey_id"
...
CREATE TABLE "audits" (
  ...
  CONSTRAINT "FK_audits.survey_id"
    FOREIGN KEY ("survey_id")
      REFERENCES "surveys"("id"),
  CONSTRAINT "FK_audits.user_id"
    FOREIGN KEY ("user_id")
      REFERENCES "users"("id")
);
...
CREATE TABLE "audits_to_violations" (
  ...
  CONSTRAINT "FK_audits_to_violations.audit_id"
    FOREIGN KEY ("audit_id")
      REFERENCES "audits"("id"),
  CONSTRAINT "FK_audits_to_violations.violation_id"
